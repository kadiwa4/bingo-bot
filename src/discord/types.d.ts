// copied from discord.js and modified
...
declare module 'discord.js' {
  ...
  export class Client extends BaseClient {
    ...
    public commands?: NodeJS.Dict<Command>;
    public config?: Config;
    public databases?: BetterSqlite3.Database[];
    public modules?: NodeJS.Dict<CommandModule>;
    public owner?: User;
    public srGuilds?: NodeJS.Dict<Guild>;

    public cleanUpGuildName(input: string): string;
    public getGuild(input: string): ?string;
    public async useCommand(message: Message, userOrMember: User | GuildMember, input?: string): Promise<boolean>;
  }
  ...
  export class Guild extends Base, EventEmitter { // edited
    constructor(client: Client, data: object);
    ...
    public commonCategories?: NodeJS.Dict<Category>;
    public config?: Config;
    public database?: BetterSqlite3.Database;
    public dataFolder?: string;
    public defaultGame?: Game;
    public fixEloTimestamp?: number;
  ...
  export class GuildMember extends PartialTextBasedChannel(Base) {
    ...
    public readonly readyEmote: string;
  }
  ...
  export class Message extends Base {
    ...
    // extended
    public acknowledge(member: GuildMember): Promise<MessageReaction>;
    public crossOut(): Promise<Message>;
    public async multiReply(
      onError: (error: any) => void,
      firstHeading: string,
      otherHeading: string,
      messageGenerator: () => Generator<string, void> | AsyncGenerator<string, void>,
    ): Promise<void>;
  ...
  interface ClientEvents {
    ...
    guildMemberRemove: [GuildMember]; // edited
    guildMembersChunk: [
